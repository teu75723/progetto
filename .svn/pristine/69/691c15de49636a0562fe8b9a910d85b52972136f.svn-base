...
class ca_customers_list extends ca_customers {
	...
	function getFailureMessage() {
        $m= new function_1();
        return $m-> getFailureMessage1();
	}

	function setFailureMessage($v) {
        $m= new function_1();
        $m-> setFailureMessage1($v);
	}

	function getSuccessMessage() {
        $m= new function_1();
        return $m-> getSuccessMessage1();
	}

	function setSuccessMessage($v) {
        $m= new function_1();
        $m-> setSuccessMessage1($v);
	}

	function getWarningMessage() {
        $m= new function_1();
        return $m-> getWarningMessage1();
	}

	function setWarningMessage($v) {
        $m= new function_1();
        $m-> setWarningMessage1($v);
	}
	...
	function ClearFailureMessage() {
        $m= new function_1();
        $m-> ClearFailureMessage1();
	}

	function ClearSuccessMessage() {
        $m= new function_1();
        $m-> ClearSuccessMessage1();
	}

	function ClearWarningMessage() {
        $m= new function_1();
        $m-> ClearWarningMessage1();
	}
...
<?php } ?>
		<?php if (MS_PAGINATION_STYLE==1 && !isset($a_customers_list->Pager)) $a_customers_list->Pager = new cNumericPager($a_customers_list->StartRec, $a_customers_list->DisplayRecs, $a_customers_list->TotalRecs, $a_customers_list->RecRange) ?>
				...
				<div class="ewNumericPage"><ul class="pagination">
					...
					<?php if ($a_customers_list->Pager->FirstButton->Enabled && $Language->Phrase("dir") == "rtl") { // begin of rtl ?>
